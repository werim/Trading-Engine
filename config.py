...
class TradeConfig:
    ...
    ENABLE_SPIKE_RETRACE_ENTRY: bool = _get_bool("ENABLE_SPIKE_RETRACE_ENTRY", "1")
    SPIKE_RETRACE_PCT: float = _get_float("SPIKE_RETRACE_PCT", "0.12")
    MAX_MARKET_CHASE_DISTANCE_PCT: float = _get_float("MAX_MARKET_CHASE_DISTANCE_PCT", "0.12")
    MAX_ENTRY_CHASE_PCT: float = _get_float("MAX_ENTRY_CHASE_PCT", "0.35")
    USE_STOP_ENTRY_ORDERS: bool = _get_bool("USE_STOP_ENTRY_ORDERS", "1")
    STOP_ENTRY_LIMIT_OFFSET_PCT: float = _get_float("STOP_ENTRY_LIMIT_OFFSET_PCT", "0.08")
    STOP_ENTRY_ORDER_TYPE: str = os.getenv("STOP_ENTRY_ORDER_TYPE", "STOP_MARKET").upper()
    USE_STOP_LIMIT_FOR_BREAKOUT: bool = _get_bool("USE_STOP_LIMIT_FOR_BREAKOUT", "0")
    A_PLUS_EXPECTANCY_OVERRIDE_MIN_WINRATE: float = _get_float("A_PLUS_EXPECTANCY_OVERRIDE_MIN_WINRATE", "0.68")
    A_PLUS_EXPECTANCY_OVERRIDE_MIN_SAMPLE_SIZE: int = _get_int("A_PLUS_EXPECTANCY_OVERRIDE_MIN_SAMPLE_SIZE", "25")
